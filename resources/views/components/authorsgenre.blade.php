<div class="mt-10 w-full">
    ...
    <div class="mt-4 w-full h-full flex gap-4">
        <a href="/authors" class="w-1/6 aspect-[2/1] rounded-xl overflow-hidden relative shadow-lg mix-blend-luminosity"
            style="background-image: url('https://picsum.photos/220/110?random=7')">
            <div class="absolute inset-0 bg-black bg-opacity-50 flex items-end justify-start gap-5 pl-3 pb-2">
                <div class="flex-col text-sky-100 gap-1">
                    <h2 class="font-bold text-center text-xl">Espionage</h2>
                    <p class="text-sm font-medium"> <span>328</span> Books</p>
                </div>
            </div>
        </a>
        <a href="/authors" class="w-1/6 aspect-[2/1] rounded-xl overflow-hidden relative shadow-lg mix-blend-luminosity"
