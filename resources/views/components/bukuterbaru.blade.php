            ...
            <div
                ...
                <div class="flex items-center justify-center rounded-md mt-2 group-hover:relative bottom-0 top-0">
                    <div
                        ...
                        <img src="https://picsum.photos/120?random=1" alt="" class="object-fill h-full w-full">
                    </div>
                </div>
                <div class="flex flex-col gap-1 px-4 pt-2 py-4 group-hover:absolute bottom-0">
                    <p class="text-xs font-extralight ">Paul Jarvis</p>
                    <h5 class="font-bold text-sky-800 ">Company of One: Why staying small is the next big
                        thing for
                        business</h5>
                    ...
                    <p class="font-bold ">Rp100.000</p>
                    <div class="inline-flex gap-1 items-center">
                        <p class="bg-red-300 text-red-700 px-2 font-semibold rounded-md">80%</p>
                        <p class="font-semibold text-base line-through text-slate-400">Rp500.000</p>
                    </div>
                </div>
