<footer class="bg-white antialiased dark:bg-gray-800 mt-10 w-full">
        ...
        <div class="border-b border-gray-100 py-6 dark:border-gray-700 md:py-8 lg:py-16">
            <div class="items-start gap-6 md:gap-8 lg:flex 2xl:gap-24">
                <div class="grid min-w-0 flex-1 grid-cols-2 gap-6 md:gap-8 xl:grid-cols-3">
                    ...
                    <div>
                        <h6 class="mb-4 text-sm font-semibold uppercase text-gray-900 dark:text-white">Order & Purchases
                        </h6>
                        <ul class="space-y-3">
                            <li>
                                <a href="#" title=""
                    ...
                    <div>
                        <h6 class="mb-4 text-sm font-semibold uppercase text-gray-900 dark:text-white">Payment Options
                        </h6>
                        <ul class="space-y-3">
                            <li>
                                <a href="#" title=""
                ...
                <div class="mt-6 w-full md:mt-8 lg:mt-0 lg:max-w-lg">
                    <div class="space-y-5 rounded-lg bg-gray-50 p-6 dark:bg-gray-700">
                        ...
                        <form action="#">
                            <div class="items-end space-y-4 sm:flex sm:space-y-0">
                                <div class="relative mr-3 w-full sm:w-96 lg:w-full">
                                    <label for="email"
                                        class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300"> Get
                                        the latest deals and more. </label>
                                    <input
                                ...
                                <div>
                                    <button type="submit"
                                        class="w-full cursor-pointer rounded-lg bg-primary-700 px-5 py-3 text-center text-sm font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Subscribe</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <div>
                            <p class="mb-3 text-sm font-medium text-gray-900 dark:text-white">Trade on the go with <a
                                    href="#" title="" class="underline hover:no-underline">Flowbite
                                    App</a></p>
                            ...
                            <div class="gap-4 space-y-4 sm:flex sm:space-y-0">
                                <a href="#"
                                    ...
                                    <svg class="mr-3 h-7 w-7" aria-hidden="true" focusable="false" data-prefix="fab"
        ...
        <div class="py-6 md:py-8">
            <div class="gap-4 space-y-5 xl:flex xl:items-center xl:justify-between xl:space-y-0">
                ...
                <ul class="flex flex-wrap items-center gap-4 text-sm text-gray-900 dark:text-white xl:justify-center">
                    <li><a href="#" title="" class="font-medium hover:underline"> Flowbite Express </a>
                    </li>
                    <li><a href="#" title="" class="font-medium hover:underline"> Legal Notice </a></li>
                    <li><a href="#" title="" class="font-medium hover:underline"> Product Listing Policy
                        </a></li>
                    <li><a href="#" title="" class="font-medium hover:underline"> Terms of Use </a></li>
                </ul>

                <p class="text-sm text-gray-500 dark:text-gray-400">© 2024 <a href="#"
                        class="hover:underline">Flowbite</a>, Inc. All rights reserved.</p>
            </div>
        </div>
    </div>
</footer>
