<x-layout>
    <section class="" style="background-image: url('https://picsum.photos/1590/758?blur=2&?random=1')">
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Contact Us
            </h2>
            <p class="mb-8 lg:mb-16 font-normal text-center text-slate-600 dark:text-gray-400 sm:text-xl">Got a technical
            ...
            <form action="#" class="space-y-8">
                <div>
                    ...
                    <input type="email" id="email"
                        class="placeholder-slate-400 shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                ...
                <div>
                    ...
                    <input type="text" id="subject"
                        class="block p-3 w-full text-sm placeholder-slate-400 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
