                ...
                @foreach ($allBooks as $allBook)
                    <div
                        ...
                        <div class="h-56 w-full">
                            <a href="/book">
                                <img class="mx-auto h-full dark:hidden"
                                    src="https://picsum.photos/500?random={{ $allBook->id }}" alt=""
                        ...
                        <div class="pt-6">
                            ...
                            <a href="#"
                                class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ $allBook->title }}</a>
