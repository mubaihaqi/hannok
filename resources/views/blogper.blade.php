<x-layout>
    <section class="py-8 bg-white dark:bg-gray-900 antialiased">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            <div class="mb-6 items-end justify-between space-y-4 sm:flex sm:space-y-0">
                <x-navigate>
                    ...
                    <x-slot:title2>{{ $blog->title }}</x-slot:title2>
        ...
        <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
            ...
            <main class="pt-8 pb-16 bg-white dark:bg-gray-900 antialiased flex justify-center">
                <div class="flex w-2/3 min-h-screen flex-col">
                    <article class="flex-1 w-full h-full">
                        <header class="mb-4 lg:mb-6 not-format">
                            <address class="flex items-center mb-6 not-italic">
                                <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                                    <img class="mr-4 w-16 h-16 rounded-full"
                                        src="https://picsum.photos/720?random={{ $blog->id }}" alt="Jese Leos">
                                    <div>
                                        <a href="#" rel="author"
                                        ...
                                        <p class="text-base text-gray-500 dark:text-gray-400"><time pubdate
                                                datetime="2022-02-08"
                                                title="April 23th, 2025">{{ $blog->created_at->format('M. j, Y') }}
                                            </time></p>
                                    </div>
                                </div>
                            </address>
                        ...
                        <div class="w-full">
                            <p class="w-full tracking-normal text-lg font-normal text-slate-600">
                                {{ $blog->body }}
                            </p>
                        </div>
